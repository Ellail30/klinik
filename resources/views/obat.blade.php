                ...
                <table class="table table-striped min-w-full bg-white shadow-md rounded-lg overflow-hidden">
                    <thead class="bg-gray-100">
                        <tr>
                            ...
                            <th class="px-4 py-2 text-left text-base font-semibold">Barcode</th>
                            ...
                            <th class="px-4 py-2 text-left text-base font-semibold">Minimum Stok</th>
                    ...
                    <tbody>
                        @foreach ($obat as $item)
                            <tr class="border-t">
                                ...
                                <td class="px-4 py-2 text-base">{{ $item->StokMinumum }}</td>
                                ...
                                <td class="px-4 py-2 text-base">
                                    <!-- Tombol Edit -->
                                    <button class="action-btn edit-btn text-blue-500 hover:text-blue-700" data-bs-toggle="modal"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content bg-white shadow-lg rounded-lg max-w-lg mx-auto">
                                                <div class="modal-header border-b border-gray-200">
                                                    ...
                                                    <button type="button" class="btn-close text-blue-600 hover:text-blue-800"
                                                    ...
                                                    <form id="editObatForm" method="POST">
                                                        ...
                                                        <div class="mb-4">
                                                            <label for="stok"
                                                                ...
                                                                Minimum</label>
                                                            <input type="number" id="editStokMinimum" name="StokMinimum"
                                                                class="form-control mt-1 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                                                required>
                                                        </div>
                                                        <div class="mb-4">
                                                        ...
                                                        <div class="mb-4">
                                                            <label for="HargaJual"
                                                                class="block text-sm font-medium text-gray-700">Harga
                                                                Jual</label>
                                                            <input type="number" id="editHargaJual" name="HargaJual" readonly
                                                                class="form-control mt-1 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                                                required>
                                                        </div>
                                    ...
                                    <button class="action-btn delete-btn text-red-500 hover:text-red-700" data-bs-toggle="modal"
                                        data-id="{{ $item->id_obat }}" data-name="{{ $item->NamaObat }}">
                    ...
                    <form action="{{ url('/obat') }}" method="POST" id="tambahObatForm">
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-control" name="Satuan" required>
                                @php
                                    $options = ['TABLET', 'KAPSUL', 'KAPLET', 'PIL', 'BUTIR', 'STRIP', 'BOTOL', 'TUBE', 'SACHET', 'AMPUL', 'VIAL', 'ML', 'LITER', 'TETES', 'GRAM', 'DOSIS'];
                                @endphp
                                @foreach($options as $option)
                                    <option value="{{ $option }}" {{ old('Satuan') == $option ? 'selected' : '' }}>{{ $option }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            <label for="stok" class="block text-sm font-medium text-gray-700">Stok Minimum</label>
                            <input type="number"
                                class="form-control mt-1 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500"
                                id="StokMinimum" name="StokMinimum" required>
                        </div>
                        <div class="mb-4">
