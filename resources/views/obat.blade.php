                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
<!-- Tombol Edit -->
<button class="action-btn edit-btn" data-bs-toggle="modal" data-bs-target="#editObatModal" data-id="{{ $item->id_obat }}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('obat.update', $item->id_obat) }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="id_obat" class="form-label">Kode Obat</label>
                        <input type="text" class="form-control" id="id_obat" name="id_obat" required disabled value="{{ old('id_obat', $item->id_obat ?? '') }}">
                    </div>
                    <div class="mb-3">
                        <label for="NamaObat" class="form-label">Nama Obat</label>
                        <input type="text" class="form-control" id="NamaObat" name="NamaObat" value="{{ $item->NamaObat }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="Satuan" class="form-label">Satuan</label>
                        <select class="form-control" id="Satuan" name="Satuan" required>
                    ...
                    <div class="mb-3">
                        <label for="TglEXP" class="form-label">Tanggal Expired</label>
                        <input type="date" class="form-control" id="TglEXP" name="TglEXP" value="{{ $item->TglEXP }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="NoBatch" class="form-label">NoBatch</label>
                        <input type="text" class="form-control" id="NoBatch" name="NoBatch" value="{{ $item->NoBatch }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="HargaBeli" class="form-label">Harga Beli</label>
                        <input type="number" class="form-control" id="HargaBeli" name="HargaBeli" value="{{ $item->HargaBeli }}" required>
                    </div>
