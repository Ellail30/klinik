            ...
            <form action="{{ route('processLogin') }}" method="POST">
                ...
                <div class="relative z-0 w-full mb-6 group">
                    <input type="text" id="username" name="username" required
                        class="peer block w-full appearance-none bg-transparent border-2 @error('login_error') border-red-500 @else border-gray-300 @enderror px-2 py-3 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-md mt-2 transition-all duration-200 ease-in-out" />
                    <label for="username"
                        class="absolute text-gray-500 text-sm left-2 top-3 transition-all duration-200 ease-in-out origin-[0] scale-100 peer-placeholder-shown:scale-100 peer-placeholder-shown:top-3 peer-focus:top-1 peer-focus:text-blue-500 peer-focus:scale-75 peer-focus:left-2 peer-placeholder-shown:text-base peer-focus:text-xs">Username/Email</label>
