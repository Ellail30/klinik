    ...
    <div class="p-4 sm:ml-64">
        ...
        <section class="bg-blue-500 rounded-xl dark:bg-gray-900">
            <div class="py-8 px-6 mx-auto max-w-screen-xl text-center lg:py-16">
                <h1 class="mb-2 text-xl font-bold text-white tracking-tight leading-none md:text-3xl lg:text-4xl dark:text-white">
        ...
        <section>
            <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <ul class="hidden text-sm font-medium text-center text-gray-500 divide-x divide-gray-200 rounded-lg sm:flex dark:divide-gray-600 dark:text-gray-400 rtl:divide-x-reverse" id="fullWidthTab" data-tabs-toggle="#fullWidthTabContent" role="tablist">
                    ...
                    <li class="w-full">
                        <button id="faq-tab" data-tabs-target="#faq" type="button" role="tab" aria-controls="faq" aria-selected="false" class="inline-block w-full p-4 rounded-se-lg bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600">
                            Persediaan
                        </button>
                    </li>
                </ul>
