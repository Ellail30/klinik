        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <div class="grid grid-cols-2 gap-4 mb-6 border-b pb-4">
                ...
                <div>
                    ...
                    <p class="font-semibold">{{ \Carbon\Carbon::parse($pembayaran->TanggalPembayaran)->format('d M Y H:i') }}</p>
                </div>
                <div>
            ...
            <div class="bg-gray-50 p-4 rounded-md">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="font-semibold text-green-600">Rp {{ number_format($pembayaran->TotalBayar, 0, ',', '.') }}</p>
                    </div>
            ...
            <div class="mt-6 flex justify-between">
                <button onclick="window.print()" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition duration-300">
                    Cetak Bukti
                </button>
                <a href="{{ route('apoteker.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600 transition duration-300">
